...
public class FindADuplicate {
    ...
    public static int findRepeat(int[] theArray) {
        ...
        while (floor < ceiling) {
            ...
            print("Floor " + floor + " midPoint " + midpoint + " ceiling " + ceiling);
            print("Lower F " + lowerRangeFloor + " C " + lowerRangeCeiling + " Upper F " + upperRangeFloor + " C " + upperRangeCeiling);
    ...
    public static void main(String[] args) {
        Result result = JUnitCore.runClasses(FindADuplicate.class);
